...
{!! Form::model($profiles, array('files' => true, 'class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array('cp.profiles.update', $profiles->id))) !!}
...
<div class="form-group">
    {!! Form::label('courses', 'Content', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('courses[]', \App\Course::lists('name','id') , $profiles->courses->lists('id')->toArray(), array('id' => 'courses1','class'=>'form-control','multiple')) !!}
    </div>
</div>
