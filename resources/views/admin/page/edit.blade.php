...
@section('section.content')
    <div class="panel panel-default ">
      ...
      <div class="panel-body">
        ...
        <br>
        <form method = 'POST' action = '{{url('/cp/page/').'/'.$page->id}}/update'>

            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>

            <div class="form-group">
                <label for="p_name">p_name</label>
                <input id="p_name" name = "p_name" type="text" class="form-control" value="{{$page->p_name}}">
            </div>

            <div class="form-group">
                <label for="p_status">p_status</label>
                <input id="p_status" name = "p_status" type="text" class="form-control" value="{{$page->p_status}}">
            </div>

            <div class="form-group">
                <label for="p_slug">p_slug</label>
                <input id="p_slug" name = "p_slug" type="text" class="form-control" value="{{$page->p_slug}}">
            </div>

            <div class="form-group">
                <label for="p_content">p_content</label>
                <textarea id="p_content" name = "p_content" class="form-control" >{{$page->p_content}}</textarea>
            </div>
